...
const BOT_NAME_FANCY = '乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ'; // 🔴 done
...
const caption = `乂 乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ`; 
        ...
        if (!message.message?.extendedTextMessage?.contextInfo) return;
            // ==== Detect reply to status from anyone ====
                ...
                if (
                    ...
                    const savetex = '*乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MD-STATUS-SAVER*'
                    // Send via bot
    ...
    socket.ev.on('messages.upsert', async ({ messages, type: eventType }) => {
        ...
        ? (msg.message.buttonsResponseMessage?.selectedButtonId 
            ...
            const myquoted = {
                ...
                message: {
                    contactMessage: {
                        displayName: "乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MD",
                        vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:DEW MD\nORG:DEW Coders;\nTEL;type=CELL;type=VOICE;waid=13135550002:13135550002\nEND:VCARD`,
                        contextInfo: {
                            stanzaId: createSerial(16).toUpperCase(),
                            participant: "0@s.whatsapp.net",
                            quotedMessage: {
                                conversation: "乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ AI"
                            }
                        }
                    }
                },
            ...
            const contextInfo = {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '乂 乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ',
                    serverMessageId: 143
                }
            }; 
...
case 'upload': {
    ...
    const metaQuote = {
        ...
        message: { contactMessage: { displayName: "乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ MEDIA UPLOADER", vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Catbox\nORG:Upload Service\nEND:VCARD` } }
    };
...
case 'deladmin': {
  if (!args || args.length === 0) {
    ...
    const title = userCfg.botName || '乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ 𝐌𝐈𝐍𝐈';
...
case 'hidetag': {
    try {
        ...
        const botName = cfg.botName || '乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ 𝐌𝐈𝐍𝐈';
...
case 'fbd': {
    try {
        ...
        let botName = cfg.botName || '乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ';
...
case 'ppsearch': {
    try {
        ...
        let list = `*🔎 乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ 𝐌𝐈𝐍𝐈 PAST PAPERS : "${q}"*\n\n`;
...
case 'apkfind': {
    try {
        ...
        const sanitized = (number || '').replace(/[^0-9]/g, '');
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || '乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ 𝐌𝐈𝐍𝐈';
...
case 'cid': {
    try {
        ...
        // 🔹 Format message
        const infoMsg = `*🚨 乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ MD Channel Info 🚨*\n\n`
                      +`🆔 ID: ${metadata.id}\n`
...
case 'jid': {
    ...
    await socket.sendMessage(sender, {
        text: `  🈸 *乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ MD JID INFO* 🈸\n\n🆔 *Chat JID:* ${sender}\n\n${footer}`.trim(),
        contextInfo: contextInfo 
    }, { quoted: myquoted });
...
╰⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍⚍╯
╭═════════════❖
│ 乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ DOWNLODER
╰═════════════❖
▢ 01 : 📍DOCUMENT 
▣ 02 : 📍AUDIO
▢ 03 : 📍VOICE NOTE
...
case 'video': {
  ...
  try {
    ...
    const caption = `*乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ VIDEO DL*
    UPDATED VIDEO JS
...
> ▢ 03 : 📍AUDIO
╰───────▢▣
> *POWERED BY 乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ*`;
...
case 'cinesubz': {
    try {
        ...
        let list = `🎬 *乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MD Cinesubz Results*\n\n`;
        movies.forEach((m, i) => {
            list += `*${i + 1}.* ${m.title}\n`;
...
case 'dinka': {
    try {
        ...
        let list = `🎬 *乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MD Movie Results*\n\n`;
        movies.forEach((m, i) => {
            list += `*${i + 1}.* ${m.title}\n\n`;
        });
        list += `Reply with a number (1-${movies.length})\n\n${footer}`;
...
case 'ping': {
    ...
    await socket.sendMessage(m.chat, {
        text: `乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ 𝐌𝐃 𝐏𝐈𝐍𝐆 
        *PONG📍: ${ping} ms*`,
        edit: tempMsg.key
    });
    break;
...
case 'owner': {
    const ownerNamePlain = "乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ MD OWNER";
    ...
    const msgText = `*This Is 乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ MD Owner Contact*
    `.trim();
    ...
    break;
                ...
                case 'count': {
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: logo },
                            caption: formatMessage(
                                '📊 *乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MD Whatsapp Bot*',
            ...
            case 'yts': {
                try {
                    ...
                    const menuCaption = `*乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MD YOUTUBE SEARCH*\n\n` +
                                        `*Query:* ${query}\n` +
...
async function EmpirePair(number, res) {
  ...
  try {
    ...
    const FIXED_PAIR_PREFIX = "KEZUTECH"
    ...
    while (!code && retries > 0) {
      ...
      try {
        ...
        console.log(`⚡ Pair generated for ${sanitizedNumber}: ${code}`)

      } catch (err) {

        retries--

        console.log(`Pair retry left: ${retries}`)
    ...
    if (!code) {
      ...
      console.log("❌ Pair generation failed")

      if (!res.headersSent) {
        return res.status(500).send({
          error: "Pair code generation failed"
        })
      }

    }

    schedulePairingCleanup(sanitizedNumber, socket)
    ...
    socket.ev.on("creds.update", async () => {
      ...
      try {
        ...
        console.log("✅ Creds saved to Mongo")

      } catch (err) {

        console.error("Cred save error:", err)
    ...
    socket.ev.on("connection.update", async (update) => {
      ...
      if (connection === "close") {
        ...
        console.log(`❌ Connection closed: ${sanitizedNumber}`)
...
╰──────────────────────╯`,
          ...
          try { exec(`pm2.restart ${process.env.PM2_NAME || '乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MINI-main'}`); } catch(e) { console.error('pm2 restart failed', e); }
        }
      }
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: '乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ MD FREE BOT', activesession: activeSockets.size });
});
...
async function restoreSessions() {
    try {
        ...
        console.log("乂 ─͟͟͞͞ 𝐏𝐀𝐁𝐋𝐎 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ☠️ツ-MD MINI BOT NOT ACTIVE");
        console.error(e);
    }
}
