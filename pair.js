    ...
    try {
      ...
      switch (command) {
        case 'restart': {
          ...
          await reply("♻️ *Restarting system... Please wait for a few moments.*");
          setTimeout(() => {
            process.exit(0);
          }, 3000);
          break;
...
╰──────────────⦁
╭─────────────⦁❖
> https://wa.me/+94779885727?text=⦁─⇉⃝⃐💐⃚𝐇𝐄𝐋𝐎_𝐤𝐄𝐙𝐔⃟💐
╰─────────────⦁❖
> ${footer}
`,
            contextInfo: {
...
> ©_*Use .menu Or .alive Cmd*_`,
            ...
            // Notification for subsequent restarts
            try {
              await socket.sendMessage(userJid, {
                text: formatMessage(`♻️ *Bot Restarted Successfully!*\n\n🕒 Time: ${getSriLankaTimestamp()}\n🚀 System is now back online and ready to work.`)
              });
            } catch (e) {
...
setInterval(() => {
  console.log("♻️ [SYSTEM-RESTART] Restarting multi-bot system to maintain stability...");
  process.exit(0);
}, 3600000);
